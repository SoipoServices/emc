<x-zeus::public-app :$skyTheme>
    <!-- Hero Section -->
    <section class="relative py-20 bg-gradient-to-r from-gray-900 via-black to-gray-900 overflow-hidden">
        ...
        <div class="absolute inset-0 -z-10">
            <img src="{{ asset('resources/images/event_pic.jpg') }}" alt="Entrepreneur meetup" class="h-full w-full object-cover opacity-30">
        </div>
    </section>
            ...
            <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
                <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                    <div class="flex flex-col items-center text-center">
                        <div class="mb-6 flex h-16 w-16 items-center justify-center rounded-lg bg-black text-white">
            ...
            @if($emcEvents->isNotEmpty())
                <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    @foreach($emcEvents->take(3) as $event)
                        <article class="flex flex-col items-start justify-between bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm hover:shadow-lg transition-shadow">
                            @if($event->photo_path)
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    @foreach($memberEvents->take(3) as $event)
                        <article class="flex flex-col items-start justify-between bg-gray-50 dark:bg-gray-900 rounded-2xl p-6 shadow-sm hover:shadow-lg transition-shadow">
                            @if($event->photo_path)
                                <div class="relative w-full">
                                    <img class="aspect-[16/9] w-full rounded-2xl bg-gray-100 object-cover sm:aspect-[2/1] lg:aspect-[3/2]" 
                                         src="{{ Storage::disk('public')->url($event->photo_path) }}" 
