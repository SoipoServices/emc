    ...
    <div class="px-4 py-3 border-b border-gray-200 top-16 bg-white/80 dark:bg-black/80 backdrop-blur-md dark:border-gray-800">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('private.businesses.create') }}" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-full hover:bg-blue-700 transition-colors">
                    Add Business
                </a>
            </div>
        </div>
    ...
    <div class="p-6">
                ...
                @foreach($businesses as $business)
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                        @if($business->is_sponsor)
                            <!-- Sponsor Badge -->
                            <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 text-white px-4 py-2 text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <span>⭐</span>
                                    <span class="font-bold text-sm">SPONSOR STATUS</span>
                                    <span>⭐</span>
                                </div>
                            </div>
                        @endif
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-6">Get started by creating your first business listing.</p>
                <a href="{{ route('private.businesses.create') }}" 
