        ...
        <div class="space-y-2">
            @foreach($pages as $post)
                <a href="{{ route('page',$post->slug) }}" 
                   class="flex items-center gap-3 p-3 transition-colors bg-gray-50 rounded-xl hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 group">
                    ...
                    @else
                        <div class="flex items-center justify-center flex-shrink-0 w-8 h-8 bg-gray-200 rounded-lg dark:bg-gray-600">
