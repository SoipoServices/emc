        ...
        <div class="flex-1 min-w-0">
            ...
            <div class="flex items-start justify-between mb-3">
                ...
                <div class="flex items-center gap-2 ml-4">
                    ...
                    <a href="{{ route('public.event.show', $event->slug) }}" class="p-2 text-gray-400 transition-colors rounded-lg hover:text-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 dark:hover:text-green-400" title="View Event">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
