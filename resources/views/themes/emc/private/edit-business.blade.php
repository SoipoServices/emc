            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Upload a new logo to replace the current one. Max file size: 1MB</p>
                        <div id="file-size-error" class="hidden mt-1 text-sm text-red-600 dark:text-red-400">File size must be less than 1MB. Please choose a smaller image.</div>
                        @error('logo')
