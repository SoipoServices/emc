    ...
    <section class="relative py-20 overflow-hidden bg-gray-50 dark:bg-gray-900">
        <div class="px-6 mx-auto max-w-7xl lg:px-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="mt-16 prose prose-lg prose-gray max-w-none dark:prose-invert">
                    ...
                    <h2>4. Limitations</h2>
                    <p>
                        In no event shall our organization or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on this website.
                    </p>
