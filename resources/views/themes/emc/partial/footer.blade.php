<footer class="mt-auto bg-white border-t border-gray-200 dark:bg-black dark:border-gray-800">
        ...
        <div class="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex gap-3">
                    <a href="https://www.linkedin.com/groups/9588305/" class="text-gray-500 transition-colors hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400" target="_blank">
                        <x-fab-linkedin class="w-5 h-5" />
                    </a>
                    <a href="https://www.facebook.com/groups/6784218835040596/" class="text-gray-500 transition-colors hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400" target="_blank">
                        <x-fab-facebook-f class="w-5 h-5" />
                    </a>
                    <a href="mailto:hello@em-ca.org" class="text-gray-500 transition-colors hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400">
