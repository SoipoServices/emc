                        ...
                        <form action="{{ route('login') }}" method="POST" class="space-y-6">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <label for="remember" class="block ml-3 text-sm text-gray-900 dark:text-white">
                                        {{ __('Remember me') }}
                                    </label>
                                </div>
                            ...
                            <div class="mt-6">
                                <div class="relative">
                                    ...
                                    <div class="relative flex justify-center text-sm">
                                        <span class="px-2 text-gray-500 bg-white dark:bg-gray-800 dark:text-gray-400">{{ __('Or continue with') }}</span>
                                    </div>
                                </div>
