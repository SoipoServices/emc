                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form @submit.prevent="submitComment(post.id)" class="mt-2">
                                        <textarea v-model="form.body" class="w-full border-gray-300 rounded-md shadow-sm dark:bg-gray-800 dark:text-white focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" rows="2" placeholder="Add a comment..."></textarea>
