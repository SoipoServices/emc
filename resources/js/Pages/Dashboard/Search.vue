    ...
    <form class="max-w-lg mx-auto" @submitted="searchUser">
        <div class="form-control ">
            <div class="flex input-group">
                <select name="category" @change="searchUser" class="py-2 text-white bg-gray-800 rounded-l-lg border-inherit dark:bg-gray-200 " v-model="form.category">
                ...
                <input type="search" name="search" v-model="form.search" class="w-full text-gray-800 border-inherit dark:bg-gray-900 dark:text-white"
